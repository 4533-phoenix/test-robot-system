...
public final class FunctionalAction extends Action {
    ...
    public FunctionalAction(Runnable startMethod, Runnable runMethod, Callable<Boolean> conditionMethod, Runnable endMethod, boolean willCancel, boolean isEvent) {
        super(runMethod, willCancel, isEvent);
